...
- [CAD pose joint-lite training](cad-pose-joint-lite-training.md): pose-first joint adaptation, train/eval IoU filtering, anchor losses, differential learning rates, launch configuration, and checkpoint-selection criteria.
