...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/runs/cad_pose_easy10_5k_quality_off_fullset010_e100}"
DEVICE="${DEVICE:-cuda:0}"
EPOCHS="${EPOCHS:-100}"
PYTHON_BIN="${PYTHON_BIN:-${REPO_ROOT}/.venv/bin/python}"

# Full-dataset counterpart to the overfit-50 quality-off/full-set-0.1 run.
# Color augmentation and the frozen joint-lite visual backbone are unchanged.
