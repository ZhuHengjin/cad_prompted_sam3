...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/runs/cad_pose_easy10_overfit50_quality_off_fullset010}"
DEVICE="${DEVICE:-cuda:0}"
EPOCHS="${EPOCHS:-500}"
PYTHON_BIN="${PYTHON_BIN:-${REPO_ROOT}/.venv/bin/python}"

# This is a controlled ablation of the original overfit-50 recipe:
# - retain the existing color augmentation;
# - remove the detached pose-quality objective;
# - give the full-placement point-set objective a small weight;
# - retain the joint-lite frozen visual backbone and batch/update settings.
