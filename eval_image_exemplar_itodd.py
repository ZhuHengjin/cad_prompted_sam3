...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dataset_root",
        type=str,
        default="/sata1/data/kevin/bop_datasets/ITODD",
        help="Path to the ITODD dataset root.",
    )
    parser.add_argument(
        "--reference_dir",
        type=str,
        default="/sata1/data/kevin/bop_datasets/ITODD/models_rendered_blender",
...
def main() -> None:
    ...
    all_entries: List[Dict[str, str]] = []
    cur_samples, cur_entries = collect_itodd_object_samples(str(dataset_root), sub_sample=args.sub_sample)
